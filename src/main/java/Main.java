...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Is the passed value in the tree?: " + tree.contains(900)); // expect false
        System.out.println("Is the passed value in the tree?: " + tree.contains(66)); // expect true
